...
(defun oldt-jira-make-ticket-directory ()
  (interactive)
  (when-let (ticket (oldt-project-get-property "TICKET"))
    (let ((dir (oldt-project-get-property "DIR"))
          (archive (oldt-project-get-property "ARCHIVE")))
      (mkdir dir t)
      (mkdir archive t))))
...
(add-hook 'org-capture-before-finalize-hook 'oldt-jira-make-ticket-directory)
